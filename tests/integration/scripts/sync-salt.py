...
MNEMONIC = sys.argv[2]
FETCH_CONFIG_PATH = Path(sys.argv[3]) if len(sys.argv) > 3 else Path("/root/.buncker/config.json")
...
config = {"salt": DAEMON_SALT, "derived_key_check": derived_key_check, "registries": {}}
